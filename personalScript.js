...
saveButton.addEventListener("click",()=>{
    ...
    console.log(myArray);
    localStorage.setItem("personal-task",JSON.stringify(myArray));
    alert("Task Saved");
})
...
function getTask(){
                          const pending = JSON.parse(localStorage.getItem("personal-task"));
                          console.log(pending);
...
const saveNotes = () =>{
  ...
  console.log(myArray);
  localStorage.setItem("personal-notes", JSON.stringify(myArray));
}


const getlocalData = () => {
  const lsnotes = JSON.parse(localStorage.getItem("personal-notes"));
  console.log(lsnotes);
